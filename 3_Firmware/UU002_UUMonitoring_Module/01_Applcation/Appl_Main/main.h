...
#define SW1_BUT_Pin GPIO_PIN_5
#define SW1_BUT_GPIO_Port GPIOA
#define SW2_BOX_Pin GPIO_PIN_6
#define SW2_BOX_GPIO_Port GPIOA
#define I2C1_EN_Pin GPIO_PIN_0
