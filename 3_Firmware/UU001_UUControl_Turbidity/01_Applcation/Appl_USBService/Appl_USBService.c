...
int APPL_USB_Manual_Measurements(int argc, char *argv[]);
int APPL_USB_Manual_GETMeasurements(int argc, char *argv[]);
...
EKM_CMD_tCmdLineEntry APPL_USB_CMD_Manual_Measurements;
EKM_CMD_tCmdLineEntry APPL_USB_CMD_Manual_GETMeasurements;
...
void APPL_USB_Init(void)
{
    ...
    APPL_USB_CMD_ANALOG.next = &APPL_USB_CMD_Manual_Measurements;

    APPL_USB_CMD_Manual_Measurements.EKM_CMD_pcCmd = "Tur";
    APPL_USB_CMD_Manual_Measurements.EKM_CMD_pcHelp = "Turbidity Manual measurements";
    APPL_USB_CMD_Manual_Measurements.EKM_CMD_pfnCmd = &APPL_USB_Manual_Measurements;
    APPL_USB_CMD_Manual_Measurements.next = &APPL_USB_CMD_Manual_GETMeasurements;

    APPL_USB_CMD_Manual_GETMeasurements.EKM_CMD_pcCmd = "tgm";
    APPL_USB_CMD_Manual_GETMeasurements.EKM_CMD_pcHelp = "Turbidity Manual measurements";
    APPL_USB_CMD_Manual_GETMeasurements.EKM_CMD_pfnCmd = &APPL_USB_Manual_GETMeasurements;
    APPL_USB_CMD_Manual_GETMeasurements.next = (void *)0;
...
/*******************************************************************************
 * Function: APPL_USB_Manual_Measurements
 *
 * Parameters:      -
 * Returned value:  -
 *
...
int APPL_USB_Manual_Measurements(int argc, char *argv[])
{
    APPL_Turbidity_s.Stage = 1;
    //APPL_Turbidity_GETMeasurement();
    APPL_USB_printf("Turbidity Function Manual\r\n");
    return 0;
}

/*******************************************************************************
 * Function: APPL_USB_Manual_GETMeasurements
 *
 * Parameters:      -
 * Returned value:  -
 *
